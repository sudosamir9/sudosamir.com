...
T-04-01 FX needs a reindex. T-04-02 `rex` makes a knowledge object. T-04-03 Validate on delimiter path. T-04-04 Save defaults to App. T-04-05 field values case sensitive (Apress contradiction). T-04-06 `eventtype`/`tag` are default fields. T-04-07 20% rule affects extraction. T-04-08 `rex` requires `field=`. T-04-09 `max_match` default unlimited. T-04-10 `erex` persists. T-04-11 always able to undo a regex edit. T-04-12 `extract` takes `field=`. T-04-13 must rename all delimiter fields. T-04-14 FX always writes the same conf. T-04-15 delimiters for unstructured data (Apress answer-key error). T-04-16 Event Actions starts at Select Sample. T-04-17 delimiter extraction editable as regex. T-04-18 sample and extraction limits.
